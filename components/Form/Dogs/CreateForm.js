...
function CreateForm({ type }) {
  ...
  useEffect(() => {
    if (type === "found") {
      setSubmitUrl("/api/user/found-dogs/create");
    }
    if (type === "lost") {
      setSubmitUrl("/api/user/lost-dogs/create");
    }
  ...
  return (
    <div className="max-w-2xl mx-auto mt-24">
      <h3 className="pb-4 text-center header_titles font-cherryBomb">
        {type === "found" ? "Add Found dog" : "Add Lost Dog"}
      </h3>
        ...
        <div className="grid grid-cols-1 gap-6">
          <div className="flex flex-wrap mb-6 -mx-3">
            ...
            <div className="w-full px-3 md:w-2/2">
              ...
              {uploadListingPhotosError && (
                <div className="error_messages">{uploadListingPhotosError}</div>
              )}
            </div>
          </div>
