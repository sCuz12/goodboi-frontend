...
function LostAnimalListingView() {
  ...
  const loadListingInfo = async () => {
    const { data } = await axiosInstance.get("/api/animals/lost-dogs/" + id);
...
export default LostAnimalListingView;
