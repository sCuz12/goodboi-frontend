...
function policy() {
  return (
    <>
      <div className="flex justify-center w-full text-center align-center">
        <h1 className="header_titles">policy</h1>
      </div>
      <div className="justify-center text-center">
        ...
        <p>
          ...
          agree to its terms. This Privacy Policy has been generated with the{" "}
        ...
        <p></p>
        <p>
          Like any other website, My Website uses "cookies". These cookies are
        ...
        <p>
          ...
          <a href="https://policies.google.com/technologies/ads">
            <span class="s1">https://policies.google.com/technologies/ads</span>
          </a>
          <span class="Apple-converted-space">&</span>
        </p>
        <p></p>
